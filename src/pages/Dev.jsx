...
function Dev() {
  ...
  return (
    <AnimatedPage>
      <section>
        <h1 className='text-white md:text-9xl font-["Rubik"] ml-10 xsm:text-3xl xxsm:text-[24px] xxsm:mt-5'>PROJETOS FRONT-END</h1>
        <img src={images.arrow} alt="Seta" className='ml-80 xsm:ml-48 xxsm:ml-40 xxsm: mt-4'/>
